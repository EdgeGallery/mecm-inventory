...
package org.edgegallery.mecmNorth.constant;
...
public class ResponseConst {
    ...
    /**
     * upload pkg body fail
     */
    public static final int RET_PKG_FILED_EMPTY_FAILED = 17101;

    /**
     * get third system fail.
     */
    public static final int RET_QUERY_THIRD_SYSTEM_FAILED = 17102;

    /**
     * third system not exist.
     */
    public static final int RET_THIRD_SYSTEM_NOT_FOUND = 17103;

    /**
     * update third system fail.
     */
    public static final int RET_UPDATE_THIRD_SYSTEM_FAILED = 17104;

    /**
     * delete third system fail.
     */
    public static final int RET_DELETE_THIRD_SYSTEM_FAILED = 17105;
