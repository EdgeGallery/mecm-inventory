...
import org.edgegallery.mecmNorth.facade.MecmHostServiceFacade;
...
public class MecHostController {
    ...
    public ResponseEntity<ResponseObject> queryMecmHosts(HttpServletRequest httpServletRequest) {
        ...
        return mecmHostServiceFacade.getAllMecmHosts(
                (String) httpServletRequest.getAttribute(Constant.ACCESS_TOKEN),
